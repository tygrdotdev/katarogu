							...
							<div className="flex w-full flex-col gap-2 p-2 sm:w-1/4">
								<Link href="/account" className="w-full">
									<Button
										...
										className={cn(
											...
											`${path === "/account" ? "bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50" : ""}`
										)}
									>
										General
									</Button>
								...
								<Link href="/account/privacy" className="w-full">
									<Button
										...
										className={cn(
											"w-full justify-start",
											`${path === "/account/privacy" ? "bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50" : ""}`
										)}
									>
										Privacy
									</Button>
								...
								<Link href="/account/danger" className="w-full">
									<Button
										...
										className={cn(
											...
											`${path === "/account/danger" ? "bg-red-500 text-neutral-100 dark:bg-red-700 dark:text-neutral-50" : ""}`
										)}
									>
										Danger Zone
									</Button>
